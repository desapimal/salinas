...
services=(cups sendmail bluetooth hplip postfix autofs atd ip6tables rhnsd rpcgssd rpcbind rpcsvcgssd )
...
#sed -i '14i password    sufficient    pam_unix.so md5 shadow nullok try_first_pass use_authtok remember=5' /etc/pam.d/system-auth		      
echo " "
echo "                  =====> Listo <====="
echo " "
